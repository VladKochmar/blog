<template>
  <SimpleMasterPage>
    <CommonMainSection title="Privacy Policy" text="Last Updated  on 27th January 2024" />
    <div class="max-w-768 px-4 py-16 md:py-32 mx-auto">
      <h2 class="title text-4xl md:text-5xl mb-8">Lorem ipsum dolor sit amet</h2>
      <p class="leading-relaxed text-gray-dark mb-8">
        ...
        in hendrerit gravida rutrum quisque non. Sit amet nulla facilisi morbi tempus iaculis urna.
      ...
      <p class="leading-relaxed text-gray-dark mb-8">
        ...
        quisque egestas diam. Risus in hendrerit gravida rutrum quisque non. Sit amet nulla facilisi
        morbi tempus iaculis urna. Lorem sed risus ultricies tristique nulla aliquet enim. Volutpat
      ...
      <p class="leading-relaxed text-gray-dark">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
        labore et dolore magna aliqua. Non blandit massa enim nec. Scelerisque viverra mauris in
        aliquam sem. At risus viverra adipiscing at in tellus. Sociis natoque penatibus et magnis
        dis parturient montes. Ridiculus mus mauris vitae ultricies leo. Neque egestas congue
